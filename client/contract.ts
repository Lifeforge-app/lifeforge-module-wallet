    ...
    create: {
      ...
      input: {
        body: {
          ...
          required: ['name', 'icon', 'starting_balance'],
          additionalProperties: false
        }
      },
      output: {
    ...
    getAssetAccumulatedBalance: {
      ...
      input: {
        query: {
          ...
          properties: {
            ...
            rangeMode: {
              type: 'string',
              enum: ['week', 'month', 'year', 'all', 'custom', 'quarter']
            },
            startDate: {
              type: 'string'
            },
      ...
      output: {
        OK: {
          ...
          required: ['balances', 'startBalance', 'endBalance'],
          additionalProperties: false
        },
        NOT_FOUND: true
      }
          ...
          properties: {
            income: {
              ...
              additionalProperties: {
                ...
                required: ['amount', 'count', 'percentage'],
                additionalProperties: false
              }
            },
            expenses: {
      ...
      output: {
        OK: {
          ...
          additionalProperties: {
            ...
            required: ['income', 'expenses', 'transfer', 'total', 'count'],
            additionalProperties: false
          }
        }
      }
      ...
      output: {
        OK: {
          ...
          additionalProperties: {
            ...
            required: ['transactionCount', 'accumulatedAmount'],
            additionalProperties: false
          }
        }
      }
